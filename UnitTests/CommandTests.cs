...
namespace UnitTests
{
    public class CommandTests
    {
        ...
        [Theory]
        public void Commands_GetTest(bool expectedResult, string[] parts)
        {
            var bookControllerMock = new Mock<BookController>(getTestBooks());
            Commands cmd = new Commands(bookControllerMock.Object);
            Assert.Equal(cmd.Get(parts), expectedResult);
        }
        ...
        [Theory]
        public void Commands_AddTest(bool expectedResult, string[] parts)
        {
            var bookControllerMock = new Mock<BookController>(getTestBooks());
            bookControllerMock.Setup(x => x.addBook(It.IsAny<Book>())).Returns(true);
            Commands cmd = new Commands(bookControllerMock.Object);
            Assert.Equal(cmd.Add(parts), expectedResult);
        }
        ...
        [Theory]
        public void Commands_DeleteTest(bool expectedResult, string[] parts)
        {
            var bookControllerMock = new Mock<BookController>(getTestBooks());
            bookControllerMock.Setup(x => x.deleteBook(It.IsAny<int>())).Returns(true);
            Commands cmd = new Commands(bookControllerMock.Object);
            Assert.Equal(cmd.Remove(parts), expectedResult);
        }
        ...
        [Theory]
        public void Commands_TakeTest(bool expectedResult, string[] parts)
        {
            var bookControllerMock = new Mock<BookController>(getTestBooks());
            bookControllerMock.Setup(x => x.takeBook(It.IsAny<Book>(), It.IsAny<string>(), It.IsAny<DateTime>())).Returns(true);
            Commands cmd = new Commands(bookControllerMock.Object);
            Assert.Equal(cmd.Take(parts), expectedResult);
        }
        ...
        [InlineData(true, new string[] { "1" })]
        [Theory]
        public void Commands_ReturnTest(bool expectedResult, string[] parts)
        {
            var bookControllerMock = new Mock<BookController>(getTestBooks());
            bookControllerMock.Setup(x => x.returnBook(It.IsAny<Book>())).Returns(true);
            Commands cmd = new Commands(bookControllerMock.Object);
            Assert.Equal(cmd.Return(parts), expectedResult);
        }
